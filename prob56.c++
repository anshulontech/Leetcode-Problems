...
// Approach:-
//     If the size of the array is less than 2 than their is no need to merge hence we will return the intervals array as 
// given. Else we will first sort the array and than push_back first element of the intervals to a newely created vector 
